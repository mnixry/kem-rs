#[cfg(not(unix))]
compile_error!("mlkem-native-rs only supports Unix-like platforms");
...
impl core::fmt::Display for Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::Fail => f.write_str("mlkem-native operation failed"),
            Self::OutOfMemory => f.write_str("mlkem-native out of memory"),
        }
    }
}
...
pub(crate) mod ffi {
    ...
    unsafe extern "C" {
        ...
        pub fn PQCP_MLKEM_NATIVE_MLKEM512_dec(ss: *mut u8, ct: *const u8, sk: *const u8) -> c_int;
        ...
        pub fn PQCP_MLKEM_NATIVE_MLKEM768_dec(ss: *mut u8, ct: *const u8, sk: *const u8) -> c_int;
        ...
        pub fn PQCP_MLKEM_NATIVE_MLKEM1024_dec(ss: *mut u8, ct: *const u8, sk: *const u8) -> c_int;
    }
}
...
impl_mlkem!(
    ...
    sk = 1632,
    ct = 768,
    keypair_derand = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM512_keypair_derand,
    enc_derand = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM512_enc_derand,
    dec = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM512_dec,
);
...
impl_mlkem!(
    ...
    sk = 2400,
    ct = 1088,
    keypair_derand = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM768_keypair_derand,
    enc_derand = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM768_enc_derand,
    dec = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM768_dec,
);
...
impl_mlkem!(
    ...
    sk = 3168,
    ct = 1568,
    keypair_derand = crate::ffi::PQCP_MLKEM_NATIVE_MLKEM1024_keypair_derand,
